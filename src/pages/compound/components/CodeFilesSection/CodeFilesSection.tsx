...
import { CodeFile, CompoundPattern, FileStatus, selectPattern } from '../../../../store/slices/compoundSlice';
...
function CodeFilesSection({ codeFiles, selectedPatterns, onAddCode, onResetCode, onDeleteFile }: CodeFilesSectionProps) {
